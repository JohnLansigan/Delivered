...
<body>
    ...
    <div class='main-container'>
        ...
        <ol>
            <li>
            <b>You acknowledge and agree that Upon review, your submission will be published in the Home page.</b> Any information you type 
            ...
            <li>
                <b>You agree you are providing appropriate licenses to the Delivered Website. </b>When you submit content to the website, 
            ...
            <li>
                <b>You warrant and represent your submission does not violate any applicable laws and DOES NOT contain any of the following:</b> 
                    ...
                    harassing, or hateful language, including any language that could be deemed discriminatory to anyone’s ethnicity,
                     ...
                     physical appearance. Hate speech and bullying language defined as threatening a person or writing anything meant to harm,
                      intimidate, or coerce any individual Absolutely no slurs or derogatory comments of any kind will be permitted.
                       ...
                       Content posted via the Services and, we cannot take responsibility for such Content.
            </li>
        </ol><br><br><br>
           ...
           User Agreement, including for example, copyright or trademark violations or other intellectual property misappropriation,
            ...
            the world and to let others do the same. You agree that this license includes the right for the website to provide, promote,
             ...
             individuals for the syndication, broadcast, distribution, promotion or publication of such Content on other media and services,
              subject to our terms and conditions for such Content use.</li></ul><br>

        <h2>Your Account</h2><ul><li>
        You may need to create an account to use some of our Services. You are responsible for safeguarding your account,
        so use a strong password and limit its use to this account. We cannot and will not be liable for any loss or damage arising from your 
        failure to comply with the above. We may need to provide you with certain communications, such as service announcements and administrative 
        messages. These communications are considered part of the Services and your account, and you may not be able to opt-out from receiving 
        them. If you added your phone number to your account and you later changed or deactivated that phone number, you must update your account 
        information to help prevent us from communicating with anyone who acquires your old number.
        </li></ul><br>
        <h2>Ending These Terms</h2><ul><li>
        You may end your legal agreement with the Delivered Website at any time by deactivating your accounts and discontinuing your use of the 
        Services. We may suspend or terminate your account or cease providing you with all or part of the Services at any time for any or no 
        reason, including, but not limited to, if we reasonably believe: (i) you have violated these Terms (ii) you create risk or possible legal 
        exposure for us; (iii) your account should be removed due to unlawful conduct, (iv) your account should be removed due to prolonged 
        inactivity; or (v) our provision of the Services to you is no longer commercially viable. We will make reasonable efforts to notify you by 
        the email address associated with your account or the next time you attempt to access your account, depending on the circumstances. In all 
        such cases, the Terms shall terminate, including, without limitation, your license to use the Services, except that the following sections 
        shall continue to apply: 2, 3, 5, and 6.
        </li></ul><br>

        <h2>General</h2>
        <ul><li>
        We may revise these Terms from time to time. The changes will not be retroactive, and the most current version of the Terms, which will 
        always be at this page. We will try to notify you of material revisions, for example via a service notification or an email to the email 
        associated with your account. By continuing to access or use the Services after those revisions become effective, you agree to be bound by 
        the revised Terms.
        </li></ul><br><br><br>
        ...
        <ul><li>
            ...
            We collect and control various types of personal data regarding our Users and visitors to our Sites. Such data is collected and 
            generated through your interaction with us or with our Service, through automatic means, or directly from you, from other Users, 
            from our Customers, or from other third parties (including our Service Providers, as defined below).Specifically, we collect the 
            following categories of data (which, to the extent it relates to an identified or identifiable individual, is deemed as “personal 
            data”): Data automatically collected or generated: When you visit, interact with, or use our Service, we collect, record or generate 
            certain technical data about you. We do so either independently or with the help of third party Service Providers, including through 
            the use of “cookies” and other tracking technologies. Such data consists of connectivity, technical and aggregated usage data, such as
             IP addresses and general locations, device and application data (like type, operating system, mobile device or app id, browser 
             version, locale and language settings used), date and time stamps of usage, the relevant cookies and pixels installed on or 
             interacted with via such device, and the recorded activity (sessions, clicks, use of features, logged activities and other 
             interactions) of visitors and Users in connection with our Service. In addition, phone calls (e.g., with our customer service or
              product consultants) may be automatically recorded, tracked and analyzed, for purposes including analytics, service-, operations-, 
              and business quality control and improvements, training, and record-keeping purposes. User Data received from you: When you contact 
              us, sign up to the Service and create your individual profile (“User Profile”), or sign up to an event that we host, organize or 
              sponsor, you provide us with personal data. This would typically include your name, workplace and position, contact details (such as
               e-mail, phone and address), account login details (e-mail address and passwords which are automatically hashed), as well as any 
               other data you choose to provide when you use our Service, contact us, or interact with others via our Service. For example, you
                may connect your Google or LinkedIn account when you sign up or login to the Service, and thereby provide us with your name, 
                e-mail address, image and other details available on your profile there. You may also provide us with your profile photo, 
                location, time-zone, skills, device, general location, and activity logs and data; as well as your preferences, characteristics
                 and objectives for using the Service (collectively, “User Data”). You may also send us a “Contact Us” or support requests, or provide us with feedback, reviews, or responses to our surveys or promotions, including by submitting an online form on our Service or social media channels, by posting on any of our online public forums or communities, by sending an e-mail to any of our designated addresses, or any other form of communication. Such data may include details on an issue you are experiencing, contact information and any other documentation, screen recording, screenshots or other information. Our Customers may provide us with additional data such as their billing details, business needs and preferences. To the extent that such data concerns a non-human entity (e.g. the bank account of a company or business), it will not be regarded as “personal data” in most countries. User Data received from our Customers and Users: Customers and Users may provide us with the contact details of potential Users, such as their employees, team members and colleagues, in order for us to contact, invite or subscribe them as Users to our Service (including by using Single sign-on tools). Such data typically includes these individuals’ names, phone numbers and work emails, however additional data may be provided at the discretion of those providing it. For the purposes of this Privacy Policy, this data is also regarded as User Data. Data received from other third parties: We may receive personal data which relates to you from other sources. For example, if you participate in an event, webinar or promotion that we sponsor or participate in, we may receive your personal data from its organizers. We may also receive your contact and professional details (e.g., your name, company, position, contact details and professional experience, preferences and interests) from our Partners (defined below), from our service providers, and through the use of tools and channels commonly used for connecting between companies and individual professionals in order to explore potential business and employment opportunities, such as LinkedIn. Data obtained through Analytics Tools: We may use analytics tools (e.g. Google Analytics) to collect data about the use of our Sites and Service. Analytics tools collect data such as how often Users and visitors visit or use the Sites or Service, which pages they visit and when, which website, ad or e-mail message brought them there, and how they interact with and use our Service and its various features.
        </li></ul><br>
        ...
        <h2>Data Security</h2>
        <ul><li>
        We secure your personal data using the highest industry-standard physical, procedural and technical measures. However, please be aware that regardless of any security measures used, we cannot and do not guarantee the absolute protection and security of any personal data stored with us.
        </li></ul><br>
